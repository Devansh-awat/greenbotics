...
| [<img src="other/readmephotos/Thumbnail.gif" alt="Robot Video" />](https://youtu.be/tl9SpU311F4) | <img src="other/readmephotos/YoutubeQR.svg" alt="YoutubeQR" style="zoom:10%;" /> <br />Scan QR code to open in YouTube |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
